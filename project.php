						...
						<div class="campaign-item clearfix">
							<div class="campaign-image">
								<div id="owl-campaign" class="campaign-slider">
									<div class="item"><img src="images/campaign-recent-01.jpg" alt=""></div>
									<div class="item"><img src="images/campaign-recent-02.jpg" alt=""></div>
									<div class="item"><img src="images/campaign-recent-03.jpg" alt=""></div>
								</div>
							</div>
							<div class="campaign-box">
								<a href="#" class="category">Crafts</a>
								<h3>The Oreous Pillow</h3>
								<div class="campaign-description"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam tempor, ipsum ut mattis commodo, eros justo feugiat ante, sed tristique erat urna et nibh. Donec nec rhoncus mi, non laoreet tortor. Proin ullamcorper ipsum interdum tellus scelerisque, a ultricies urna vehicula. Mauris faucibus metus quis commodo pharetra.</p></div>
								<div class="campaign-author clearfix">
									<div class="author-profile">
										<a class="author-icon" href="#"><img src="images/author-01.png" alt=""></a>by <a class="author-name" href="#">Andrew Noah</a>
									</div>
								...
								<div class="button">
									...
									<a href="campaign_payment.php">	<button class="btn-primary" type="submit">Back this Campaign</button></a>
